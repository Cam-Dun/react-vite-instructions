...
2. Initialize Vite project
	...
	1. View the template project in the browser.
		* View the project in browser by typing the `http://localhost:5173/` in the search bar, or by pressing (<kbd>ctrl</kbd> + <kbd>click</kbd>) on the link provided in the terminal. The browser should show a working page as shown in the following screen shot. ![[School/Fall2024/Writing/InstructionsFinal/20241030231603.png]]
...
4. Type `rafce` and enter. 
	...
	* The resulting code should look like the following screenshot: ![[School/Fall2024/Writing/InstructionsFinal/FirstComponentSS.png]]
...
6. Use the component:
	...
	* "FirstPage.tsx" file should look something like this: ![[School/Fall2024/Writing/InstructionsFinal/FirstComponentComplete.png]]
...
2. Clear the template code
	...
	* After everything is deleted, it should look like the following image: ![[School/Fall2024/Writing/InstructionsFinal/AppSS.png]]
3. Import Pages
	* At the top of the file, write: 
...
5. Save. Open the browser from before or reopen the url, the single page application should be completed: ![[School/Fall2024/Writing/InstructionsFinal/SinglePageComplete.png]]
...
3. follow the template provided in the following image:![[School/Fall2024/Writing/InstructionsFinal/MenuComponent.png]]
	* This is defining Routes to different URLs, but nothing will be there, yet. 
4. The first page will be a landing page with out a navbar, so for convenience, import and add the Menu Component to the first page. It will look like: ![[School/Fall2024/Writing/InstructionsFinal/AddMenu.png]]

### Step 2: Multiple Page Functionality 
1. Follow Part 1, Step 3 to make "SecondComponent.tsx" and "ThirdComponent.tsx".
3. Follow Step 4 to make "SecondPage.tsx", "ThirdPage.tsx" and "NotFoundPage.tsx"![[School/Fall2024/Writing/InstructionsFinal/Filesss.png]]
...
* Not Found Page: 
	* try typing a path in the search bar (like where the two is) that does not exist: ![[School/Fall2024/Writing/InstructionsFinal/NotFound.png]]
