...
<br/> ![img](InstructionsFinal/120241031014740.png)
## Introduction
### Goals/Outcomes
...
2. Initialize Vite project
	...
	2.  Navigate to the new folder and install dependencies. The terminal should read`Done. Now run:` Follow the given instructions, enter:
		...
		4. `npm run dev` to run the Vite template project locally. If everything was done properly, the terminal should look like the following screenshot: <br/> ![img](InstructionsFinal/20241030230819.png)
	...
	3. View the template project in the browser.
		* View the project in browser by typing the `http://localhost:5173/` in the search bar, or by pressing (<kbd>ctrl</kbd> + <kbd>click</kbd>) on the link provided in the terminal. The browser should show a working page as shown in the following screen shot. 
		...
		<br/> ![img](InstructionsFinal/20241030231603.png)
...
1. Create two new folders in `src` directory:
	...
	<br/> ![img](InstructionsFinal/FileStructure.png)
...
4. Type `rafce` and enter. 
	...
	* The resulting code should look like the following screenshot: 
	<br/> ![img](InstructionsFinal/FirstComponentSS.png)
...
6. Use the component:
	...
	* "FirstPage.tsx" file should look something like this: 
	<br/> ![img](InstructionsFinal/FirstComponentComplete.png)
...
2. Clear the template code
	...
	* After everything is deleted, it should look like the following image: 
	<br/> ![img](InstructionsFinal/AppSS.png)
...
<br/> ![img](InstructionsFinal/SinglePageComplete.png)
...
<br/> ![img](InstructionsFinal/MenuComponent.png)
...
<br/> ![img](InstructionsFinal/AddMenu.png)
...
1. import in react-router-dom functions in App.tsx: 
	...
	* Outlet
	* Scroll Restoration
<br/> ![img](InstructionsFinal/importrrd.png)
...
<br/> ![img](InstructionsFinal/NavBarWrapper.png)

3. Create Browser Router: 
<br/> ![img](InstructionsFinal/BrowserRouterss.png)
...
<br/> ![img](InstructionsFinal/AppFunction.png)
...
### Final Product
* Home Page:
	<br/> ![img](InstructionsFinal/FinalFirstPage.png)
	
* Second Page:
	<br/> ![img](InstructionsFinal/FinalTwo.png)
	
* Third Page: 
	<br/> ![img](InstructionsFinal/FinalThree.png)
	
* Not Found Page: 
	* try typing a path in the search bar (like where the two is) that does not exist: 
	<br/> ![img](InstructionsFinal/NotFound.png)
